...
List<KasseBalance> computeKassen(List<Person> persons, List<Expense> expenses) {
...
List<KasseTransfer> computeKasseSettlement(
    List<Person> persons, List<Expense> expenses) {
  final kassen = computeKassen(persons, expenses);
